...
Você também pode publicar sua história. Basta clicar no botão abaixo.
    ...
    <div class="box-feed clearfix block no-padding" id="published-indicacao">
      <fieldset class="clearfix">
        <span class="title-text">Filtrar Histórias</span>
    ...
    <div class="box-feed shadow clearfix">
          <div class="box-top">
            <span class="box-title clearfix"><i class="sprite sprite3 sprite-historias_gd"></i><span class="title-publicacao">Histórias de sucesso</span><span class="data-publicacao-list">00/00/0000</span></span>
