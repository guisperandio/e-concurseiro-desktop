...
Em DICAS DE ESTUDO você terá acesso a dicas postadas por concurseiros e professores, podendo servir para uma matéria específica ou para um concurso.<br />
Você também pode postar suas dicas. Basta clicar no botão abaixo.
      </p>
    ...
    <div class="box-feed clearfix block no-padding" id="published-indicacao">
      <fieldset class="clearfix">
        <span class="title-text">Filtrar Dicas</span>
    ...
    <div class="box-feed shadow clearfix">
      <div class="box-top">
        <span class="box-title clearfix"><i class="sprite sprite3 sprite-dicas_gd"></i><span class="title-publicacao">Dicas de estudo</span><span class="data-publicacao-list">00/00/0000</span></span>
        <i class="sprite sprite3 sprite-open_white expand-publish"></i>
        <i class="sprite sprite-favorito"></i>

        <span class="box-denuncia"><i class="sprite sprite-denuncia"></i><span class="menu-name">Denunciar Publicação</span></span>
      </div>
