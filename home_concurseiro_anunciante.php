...
<div class="container_16 home-concurseiro" id="wrapper-interna">
  ...
  <div class="grid_8" id="content-middle">
    ...
    <div class="box-feed clearfix tour-visitante">
      <p>
        Você está navegando como anunciante e, por isso, não poderá publicar na rede,
interagir com os demais usuários ou acessar os aplicativos.<br /><br />

Para gerenciar seus anúncios ou analisar o desempenho das suas campanhas ativas
ou criar novas camapnhas, acesse o dashboard do anunciante:

      </p>
      <button class="btn btn-oceanblue center">ACESSAR O ADMIN</button>
    </div>
