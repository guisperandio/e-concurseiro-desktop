...
<div class="container_16 home-concurseiro" id="wrapper-interna">
  ...
  <div class="grid_8" id="content-middle">
    ...
    <div class="box-feed clearfix tour-visitante">
      <p>
        Você está navegando como visitante e apesar de poder visualizar todas as publicações
não poderá publicar na rede, interagir com os demais usuários ou acessar os aplicativos.<br /><br />

Faça seu cadastro agora mesmo e aproveite todas as funcionalidades do e-concurseiro!<br /><br />

O acesso à rede e às ferramentas é 100% GRATUITO para os concurseiros.
      </p>
      <button class="btn btn-oceanblue left">CADASTRAR USUÁRIO</button>
      <a href="#">Você é <b>professor</b> de cursos para concursos? <b style="font-weight: 400 !important">Clique aqui.</b></a>
      <a href="#">Cadastro de <b>instituições ou anunciantes:</b> <b style="font-weight: 400 !important">Clique aqui.</b></a>
    </div>
