        ...
        <div class="grid_12 no-margin">
            ...
            <div class="grid_12" id="content-middle">
                ...
                <div class="box-interesse">
                    <h5 class="bigtitle center-text">Receitas com anúncios - Ganho por período - Listar Pagamentos</h5>
                    ...
                    <div class="box-interesse clearfix financeiro">
                        ...
                        <button class="btn bgr-oceanblue left quarter">Ver desempenho</button>
                    </div>
                    <div class="box-interesse clearfix">
                      ...
                      <i class="sprite sprite-demonstrativo">Demonstrativo para IRPF</i>
                        <table class="table-professor">
                          ...
                          <tr class="linha odd">
                            ...
                            <td>15</td>
                            <td>140,00</td>
                            <td>disponível em 00/00/0000</td>
                          </tr>
                          <tr class="linha">
                            <td>00/00/0000</td>
                            <td>15</td>
