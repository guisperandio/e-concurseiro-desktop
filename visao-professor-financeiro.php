        ...
        <div class="grid_12 no-margin">
            ...
            <div class="grid_12" id="content-middle">
                ...
                <div class="box-interesse">
                    <h5 class="bigtitle center-text">Vendas de cursos - Demonstrativo mensal</h5>


                    <div class="box-interesse clearfix financeiro">
                      <div class="left same-line select-div">
                          <span class="title-interesse">Mês</span>
                          <div class="select-option">
                              <select class="sprite4 sprite-seta_option">
                                  <option>
                                      MÊS
                                  </option>
                                  <option>
                      ...
                      <div class="left same-line select-div">
                          <span class="title-interesse">Ano</span>
                          <div class="select-option">
                              <select class="sprite4 sprite-seta_option">
                                  <option>
                                      ANO
                        ...
                        <button class="btn bgr-oceanblue left quarter">Visualizar demonstrativo</button>
                    </div>
                    <div class="box-interesse clearfix">
                        <span class="bluetitle">Período: Jan/2016</span>
                        ...
                        <table class="table-professor">
                          <tr class="topo">
                            ...
                            <th>Quantidade</th>
                            <th>Valor Bruto</th>
                            <th>Taxas e Comissões</th>
                            <th>Líquido</th>
                          </tr>
                          <tr class="linha odd">
                            <td class="align-left">Protuguês para INSS 2015/2016 - pós edital</td>
                            <td>1</td>
                            <td>104,30</td>
                            <td>104,30</td>
                            <td>14,00</td>
