...
border-bottom: 10px solid #fff;"></span>
      <span class="text-alert">Se o edital possuir conteúdos apresentados em separado, você poderá inserir mais de um PDF, especificando no campo observação.</span>
      <div class="upload clearfix">
        ...
        <div class="input-editais clearfix">
            <label>Título. (ex.: Anexo 1)</label>
            <input type="text" class="input-edital" />
    ...
    <div class="box-feed shadow clearfix">
      <div class="box-top">
      <span class="box-title clearfix"><i class="sprite sprite-editais_gd"></i><span class="title-publicacao">Editais</span><span class="data-publicacao-list">00/00/0000</span></span>
      ...
      <div class="box-content">
        ...
        <div class="feed-text clearfix">
          <div class="edital clearfix">
            ...
            <a href="#" class="sprite sprite-pdf">Baixar Edital</a>
